...
type ExecutorOptionsV2 struct {
	normalizedASTCache graphql.NormalizedASTCache
	executionOptions   []graphql.ExecutionOptionsV2
}

func WithNormalizedASTCache(cache graphql.NormalizedASTCache) ExecutorOptionsV2Fn {
	return func(opts *ExecutorOptionsV2) {
		opts.normalizedASTCache = cache
	}
}
