...
func (ec *executionContext) _Query_userOrProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOUserOrProduct2ᚕgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋreviewsᚋgraphᚋmodelᚐUserOrProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUserOrProduct2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋreviewsᚋgraphᚋmodelᚐUserOrProduct(ctx context.Context, sel ast.SelectionSet, v model.UserOrProduct) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOUserOrProduct2ᚕgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋreviewsᚋgraphᚋmodelᚐUserOrProduct(ctx context.Context, sel ast.SelectionSet, v []model.UserOrProduct) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOUserOrProduct2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋreviewsᚋgraphᚋmodelᚐUserOrProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
